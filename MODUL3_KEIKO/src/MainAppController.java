    ...
    private void addTask() {
        try {
            ...
            if (titleField.getText().isEmpty() || priorityBox.getValue() == null || dueDatePicker.getValue() == null) {
                ...
                throw new MissingFieldException("Mohon untuk mengisi semua fields");
            }

            if (dueDatePicker.getValue().isBefore(LocalDate.now())) {
                // TODO: Throw new InvalidDateException dengan pesan yang sesua
                throw new InvalidDateException("Tanggal tak bisa dari masa lampau"); 
            }
    ...
    private void deleteTask() {
        try {
            ...
            if (selected == null) {
                ...
                throw new TaskNotSelectedException("Tidak ada Task yang di select");  
